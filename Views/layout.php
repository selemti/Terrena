...
use function Terrena\Core\asset;
use function Terrena\Core\url;

$base = $GLOBALS['__BASE__'] ?? '/';

// Views/layout.php
// (fragmento inicial recomendado)
...
<head>
  ...
  <link rel="stylesheet" href="/terrena/Terrena/assets/css/caja.css">
</head>
<body>
...
<hr style="margin:0">
    ...
    <main class="main-content flex-grow-1">
      ...
      <div class="top-bar sticky-top">
        <div class="d-flex align-items-center gap-2">
          ...
          <h1 class="top-bar-title mb-0"><?php echo $title ?? '<i class="fa-solid fa-gauge"></i>Dashboard' ?></h1>
        </div>
  ...
  <script src="/terrena/Terrena/assets/vendor/cleave.min.js"></script>
  <script src="/terrena/Terrena/assets/js/moneda.js" defer></script>

  <?php
    $isCaja = (strpos($_SERVER['REQUEST_URI'] ?? '', '/caja/') !== false);
    if ($isCaja): ?>
  <!--script src="/terrena/Terrena/assets/js/caja.js"></script-->
  <?php endif; ?>
</body>
</html>
